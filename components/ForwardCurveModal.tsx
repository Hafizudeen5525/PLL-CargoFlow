                                                        ...
                                                        >
                                                            {active ? (
                                                                ...
                                                                <div className={`px-3 text-xs font-mono truncate w-full ${isMonthCol ? 'font-bold text-slate-700' : 'text-right text-slate-600'}`}>
                                                                    {isMonthCol ? (val || '-') : (val !== undefined ? Number(val).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 3 }) : '')}
                                                                </div>
                                                            )}
                                                        </div>
                                                    );
                            ...
                            <div className="h-8 bg-slate-800 text-white flex items-center px-4 justify-between shrink-0">
                                ...
                                {selectionStats && selectionStats.numericCount > 0 && (
                                    <div className="flex gap-6 text-[10px] font-mono">
                                        <div className="flex gap-1.5"><span className="text-slate-400">AVERAGE:</span> <span className="font-bold">{selectionStats.avg.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 3 })}</span></div>
                                        ...
                                        <div className="flex gap-1.5"><span className="text-slate-400">SUM:</span> <span className="font-bold">{selectionStats.sum.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 3 })}</span></div>
                                    </div>
                                )}
                            </div>
                        </div>
