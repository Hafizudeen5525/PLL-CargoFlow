...
const NAV_ITEMS = [
  ...
  { id: 'report', label: 'Executive Report', icon: 'M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z' },
        ...
        <div className="flex-1 flex flex-col min-h-0 p-3 lg:p-6 bg-slate-100 overflow-y-auto custom-scrollbar">
            <AnimatePresence mode="wait">
                {view === 'dashboard' ? (
                    ...
                    <motion.div key="report" initial={{opacity:0, x:-20}} animate={{opacity:1, x:0}} exit={{opacity:0, x:20}} className="flex-1 flex flex-col min-h-0">
                        <SummarizedReport 
                            profiles={profiles} 
                            portfolioYear={portfolioYear}
                        />
